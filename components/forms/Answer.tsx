...
const Answer = ({ question, questionId, authorId }: Props) => {
  ...
  const generateAIAnswer = async () => {
    ...
    try {
      ...
      // const aiAnswer: { choices?: { message?: { content?: string } }[] } =
      //   await response.json();
      // console.log("aiAnswer", aiAnswer); // Log the entire response object

      // if (
      //   aiAnswer?.choices &&
      //   Array.isArray(aiAnswer.choices) &&
      //   aiAnswer.choices.length > 0
      // ) {
      //   const firstChoice = aiAnswer.choices[0];
